...
function App() {
  const [authUser, setAuthUser] = reactExports.useState(window.authUser || null);
  ...
  if (!authUser) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Login, { onLogin: (user) => {
      window.authUser = user;
      setAuthUser(user);
    } });
  }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-y-auto flex-1", children: notes.map((note) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 mt-1", children: new Date(note.updated_at).toLocaleDateString() })
          ]
        },
        note.id
      )) }),
